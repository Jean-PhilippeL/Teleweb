...
var telewebApp = angular.module('telewebApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'telewebAppUtils', 'pascalprecht.translate', 'truncate']);
